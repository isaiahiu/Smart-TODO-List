...
INSERT INTO categories (name) VALUE ('Read');
INSERT INTO categories (name) VALUE ('Eat');
INSERT INTO categories (name) VALUE ('Watch');
INSERT INTO categories (name) VALUE ('Buy');
